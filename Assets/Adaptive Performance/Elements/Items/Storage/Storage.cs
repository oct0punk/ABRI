...
public class Storage : MonoBehaviour
{
    ...
    public void Craft(CraftableMaterial material)
    {
        Consume(material.craftMaterials);
        Add(material);
    }

    public void Consume(CraftRes[] materials)
    {
    ...
    public bool CanCraft(CraftRes[] materials)
    {
        return GetMissedMats(materials).Count == 0;
    }

    public List<RawMaterial> GetMissedMats(CraftRes[] materials)
    {
